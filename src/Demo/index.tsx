...
import { Box, Button, Fade, Modal, Slide, TextField, useScrollTrigger } from '@mui/material';
import { AccountCircle } from '@mui/icons-material';
import { NFTCollectible } from '../typechain-types/contracts/NFTCollectible';
...
function Demo(props: Props,) {
    ...
    const loadNFTCollection = async () => {
        try {
          ...
          setNFTCollection(
            [
              `${baseURI}Screenshot 2022-03-22 094313.jpg`,
              `${baseURI}priority.jpg`,
              `${baseURI}probtype.jpg`,
              `${baseURI}winteam.jpg`,
              `${baseURI}wo-mapping-corrigo.jpg`,
            ]);
        } catch (error) {
          console.log(error);
        }
